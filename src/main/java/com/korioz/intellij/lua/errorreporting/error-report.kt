...
package com.korioz.intellij.lua.errorreporting
...
import com.korioz.intellij.lua.util.appendLine
...
private fun getKeyValuePairs(
	...
	PluginManagerCore.getPlugin(PluginId.findId("com.korioz"))?.run {
